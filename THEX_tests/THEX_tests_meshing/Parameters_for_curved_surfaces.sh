...
Work_dir="/u/moana/user/weng/Weng/LeTeil_earthquake/3D_CUBIT_mesh-master/"

###  Input data for curved topography
...
###  Input data for curved fault
Int_GRD_data=0           # do not use grid data
#GRD_data=1           # do use grid data
Int_input_data="${Work_dir}/Interface/data/LeTeil_Grandin_data.csv"
###  Smooth parameters
Int_inc=12
Int_sigma=1
Int_sample_inc=0.02
